...
function profile_update
    ...
    if params.profiling
        ...
        print_message(...
            sprintf('tm: %d 1_er_tr: %d (%3.2f) er_tr: %d (%3.2f) 1_er_ts: %d (%3.2f) er_ts: %d (%3.2f) Ypred* %.2f %.2f %.2f %.2f',...
...
function profile_update_tr
    ...
    if params.profiling
        ...
        %Yipos_list
        print_message(...
            sprintf('tm: %d iter: %d 1_er_tr: %d (%3.2f) er_tr: %d (%3.2f) K: %d Y*pos: %3.2f%% %.2f %.2f %d Yipos: %3.2f%% %.2f %.2f %.2f K: %.2f %.2f %d Mg: %.2f%% %.3f %.3f obj: %.2f gap: %.2f%% Update %.2f%% %.2f%% gap: %.2f%% Ypred* %.2f%% %.2f %.2f %.2f Ypred_i %.2f%% %.2f %.2f %.2f',...
            round(tm-profile.start_time),...
            opt_round,...
            profile.n_err,...
            profile.p_err*100,...
...
%                     Y_kappa_val((i:size(Y_kappa,1)/T_size:size(Y_kappa_val,1)),:),[]);
                ...
                [Ypred(i,:),YpredVal(i,:),Ypred_rank(i),~] = ...
                    find_worst_violator_new(...
                    Y_kappa((i:size(Y_kappa,1)/T_size:size(Y_kappa,1)),:),...
                    Y_kappa_val((i:size(Y_kappa,1)/T_size:size(Y_kappa_val,1)),:),...
                    [],IN_E,IN_gradient);
