...
names = c('cal500','scene','toy10','toy50','emotions','yeast','medical','enron','ArD15','ArD20','ArD30','cancer')
names = c('scene','toy10','emotions','yeast','enron','ArD10','ArD15','ArD20','ArD30','medical','toy50')
for(name in names)
{
